...
// before deciding where to send them. A sync failure degrades to empty-links state
// (which self-heals when /dashboard/pending runs its own defensive sync check).
