...
export function ProfileForm({
  ...
  return (
    // Column order (cross-kit profile-page standard §2.4): stall name,
    // profile picture, change password | display name, social links.
    <TwoColumnSections
      columnOne={
        <>
          <Section
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                aria-describedby={
                  pwError ? "confirm-password-error" : undefined
                }
              />
              {pwError && (
          ...
          >
            <div className="space-y-2">
              ...
              <Input
                ...
                aria-describedby={
                  displayError ? "display-name-error" : undefined
                }
              />
              {displayError && (
