...
Deploy: merqo pushed to github.com/cljiahao/merqo. qkit Phase A = PR cljiahao/Qkit#11 (branch feat/merqo-metrics, 7 tests green, on branch not merged). Runbook = docs/DEPLOY.md. Provisioning (Supabase rename/expose-schema/db-push/seed/team + Vercel x2) = user login-gated.
