...
- `commit-msg/commit-msg.sh` — thin entry point lefthook execs directly (via its
  `scripts:` convention) with the message-file path as `$1`; immediately
  delegates to `../commit-msg.sh`
