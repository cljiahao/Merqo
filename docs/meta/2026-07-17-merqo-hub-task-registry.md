...
> **Superseded 2026-08-15** — see
> [`2026-08-15-merqo-hub-task-registry.md`](2026-08-15-merqo-hub-task-registry.md)
> for the current status of every item below (kept here unmodified as
> history; do not edit this file to reflect new state).
